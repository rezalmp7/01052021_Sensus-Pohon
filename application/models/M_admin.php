...
class M_admin extends CI_Model
{
    ...
    function select_where_beetween($table, $where, $date_first, $date_second)
    {
        return $this->db->query("select * from ".$table." where ".$where." between '".$date_first." 00:00:00' and '".$date_second." 23:59:59'");
    }
    ...
    function select_laporan_pohon($select, $table, $table2, $on2, $table3, $on3, $where)
    {
        return $this->db->query("SELECT ".$select." FROM ".$table." LEFT JOIN ".$table2." ON ".$on2." LEFT JOIN ".$table3." ON ".$on3." WHERE ".$where);
    }
    // ----/pakaiquery----
    ...
    function distinct_select_select($select, $table)
    {
        $this->db->distinct();
        $this->db->select($select);
        return $this->db->get($table);
    }
    function distinct_select_select_where($select, $table, $where)
    {
        $this->db->distinct();
