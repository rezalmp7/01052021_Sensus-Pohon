...
<head>
    <title>Aplikasi Sensus Pohon Sawit</title>
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="60x60" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="72x72" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="114x114" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="144x144" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="icon" type="image/png" sizes="96x96" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url(); ?>assets/img/favicon/logo.png">
                    ...
                    <form class="uk-margin-medium-top uk-padding-large uk-padding-remove-vertical uk-form-stacked" method="POST" action="<?php echo base_url(); ?>login/login_aksi">
                        <div class="uk-margin">
                            ...
                            <div class="uk-form-controls">
                                <input class="uk-input field-default" id="form-stacked-text" type="text" name="username" placeholder="Silahkan Masukkan Username...">
                            </div>
                        </div>
                        <div class="uk-margin">
                            ...
                            <div class="uk-inline uk-width-1-1">
                                ...
                                <input class="uk-input field-default" id="myInput" type="password" name="password" placeholder="Silahkan Masukkan Password...">
                            </div>
                        </div>
